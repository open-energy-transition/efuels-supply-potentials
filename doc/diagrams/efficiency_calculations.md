...
|-----------|--------|------|------|
|efficiency |$\frac{1}{\text{gas-input}_{DRI}}$|$\frac{1}{2.78} \text{t}_{DRI}/\text{MWh}_{gas}$|ton of DRI produced per MWh of gas|
|efficiency2|$\frac{\text{ore-input}_{DRI}}{\text{gas-input}_{DRI}}$|$\frac{1.59}{2.78} \text{t}_{ore}/\text{MWh}_{gas}$|ton of iron-ore needed per MWh of gas|
|efficiency3|$i_{CO2,gas}$|$0.198 \text{tCO}_2/\text{MWh}_{gas}$|ton of $\text{CO}_2$ released to atmosphere per MWh of gas|
